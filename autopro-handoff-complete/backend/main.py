...
# bridge: CORS from env or sane defaults - HARDENED for 3007
_raw = os.getenv(
    "BACKEND_CORS_ORIGINS",
    "http://localhost:3007,http://127.0.0.1:3007,http://localhost:3003,http://127.0.0.1:3003,http://localhost:3000,http://127.0.0.1:3000,http://localhost:8080",
)
_allowed = {o.strip() for o in _raw.split(",") if o.strip()}
# harden: adaugă 3007 dacă cineva pornește Vite pe 3007
_allowed |= {"http://localhost:3007", "http://127.0.0.1:3007", "http://localhost:3003", "http://127.0.0.1:3003"}
