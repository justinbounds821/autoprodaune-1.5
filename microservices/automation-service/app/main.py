...
setup_logging("automation-service", level=os.getenv("LOG_LEVEL", "INFO"))
...
metrics = setup_metrics(app, "automation-service")
health = init_health_check("automation-service")
