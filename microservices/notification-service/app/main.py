...
setup_logging("notification-service", level=os.getenv("LOG_LEVEL", "INFO"))
...
metrics = setup_metrics(app, "notification-service")
health = init_health_check("notification-service")
