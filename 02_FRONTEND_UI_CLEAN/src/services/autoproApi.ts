...
class AutoProApiService {
  ...
  getFinancialDashboard = async (params?: Record<string, unknown>) =>
  ...
  getAIInsights = async (filters?: Record<string, unknown>) =>
    (await api.get("/api/advanced-business-intelligence/business-insights", { params: filters })).data;
  generateAIReport = async (ids: string[]) =>
    (await api.post("/api/ai/generate-report", { insightIds: ids })).data;
  getPredictiveAnalytics = async () =>
    (await api.get("/api/advanced-business-intelligence/predictive-analytics")).data;
  getComprehensiveAnalytics = async () =>
    (await api.get("/api/advanced-business-intelligence/comprehensive-analytics")).data;
  getTaxRates = async () => (await api.get("/api/financial/tax-rates")).data;
  calculateTax = async (req: { amount: number; type: string }) =>
