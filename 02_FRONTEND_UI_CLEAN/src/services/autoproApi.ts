...
class AutoProApiService {
  ...
  createLead = async (lead: Record<string, unknown>) => (await api.post("/api/leads", lead)).data;
  getFinancialDashboard = async (params?: Record<string, string | number>) =>
    (await api.get("/api/financial/dashboard", { params })).data;
  getInvoices = async () => (await api.get("/api/financial/invoices")).data;
  createInvoice = async (invoice: Record<string, unknown>) =>
  ...
  getNotifications = async (params?: Record<string, string | number>) =>
    (await api.get("/api/notify/list", { params })).data;
  markNotificationRead = async (id: string) =>
    (await api.post(`/api/notify/mark-read/${id}`)).data;
  getAIInsights = async (filters?: Record<string, string | number>) =>
  ...
  calculateTax = async (req: Record<string, unknown>) =>
  ...
  updateAutomationSettings = async (settings: Record<string, unknown>) =>
  ...
  updatePayment = async (id: string, updates: Record<string, unknown>) =>
  ...
  createPost = async (post: Record<string, unknown>) => (await api.post("/api/social/posts", post)).data;
  schedulePost = async (post: Record<string, unknown>) => (await api.post("/api/social/post-now", post)).data;
  ...
  getAdvancedVideoJobs = async (params?: Record<string, string | number>) => (await api.get("/api/advanced-video/list-generated", { params })).data;
